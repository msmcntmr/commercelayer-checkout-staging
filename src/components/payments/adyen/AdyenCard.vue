...
export default {
  computed: {
    scriptSrc () {
      return `https://checkoutshopper-${process.env.VUE_APP_ADYEN_ENV}.adyen.com/checkoutshopper/sdk/4.2.0/adyen.js`
    },
    styleHref () {
      return `https://checkoutshopper-${process.env.VUE_APP_ADYEN_ENV}.adyen.com/checkoutshopper/sdk/4.2.0/adyen.css`
    },
    styleObj () {
      return {
        base: {
